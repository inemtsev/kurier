...
class MatrixRenderingMatrixTest {
    ...
    fun `renders the matrix as body plus optional html`() = assertRenderingMatrix(
        mapOf(
            ...
            "strikethrough" to RenderedMatrix("gone", "<del>gone</del>"),
            ...
            "linkWithLabel" to RenderedMatrix("the site (https://x.com)", "<a href=\"https://x.com\">the site</a>"),
